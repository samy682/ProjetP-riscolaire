        ...
        <div class="col-md-8 col-md-offset-2">
            <form name="pollform" id="pollform" method="POST" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    <label for="nbEnfant" class="col-sm-4 control-label">@lang('Number children') *</label>

                    <div class="col-sm-8">
                    <input id="nbEnfant" type="number" name="nbEnfant" class="form-control" value="{{ config('global.nbEnfant') ?? (session()->has('form') ? session()->get('form')->nbEnfant : '') }}"/>
                    </div>
                </div>
